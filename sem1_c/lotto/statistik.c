...
/**Sucht einen char-Array nach einem bestimmten char-Wert durch und gibt aus ob dieser vorhanden ist.
 *
 * @param array   \c Input:  \n Das Array, dessen Komponenten durchsucht werden soll.\n
 *                \c Output: \n Dasselbe Array, dessen Komponenten durchsucht wurden.\n
 * @param laenge        	Die Anzahl Komponenten des Arrays.
 * @param gesuchte_zahl   Der char-Wert nach dem im Arrays gesucht werden soll.
 *
 * @return	Gibt an ob ein bestimmter char-Wert im Array enthalten ist (1) oder nicht (0).
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
/**Gibt an ob in einen char-Array alle Zahlen gerade sind.
 *
 * @param array   \c Input:  \n Das Array, dessen Komponenten durchsucht werden soll.\n
 *                \c Output: \n Dasselbe Array, dessen Komponenten durchsucht wurden.\n
 * @param laenge        	Die Anzahl Komponenten des Arrays.
 *
 * @return	Gibt an ob alle Werte im Array gerade sind (1) oder nicht (0).
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
/**Gibt an ob in einen char-Array alle Zahlen ungerade sind.
 *
 * @param array   \c Input:  \n Das Array, dessen Komponenten durchsucht werden soll.\n
 *                \c Output: \n Dasselbe Array, dessen Komponenten durchsucht wurden.\n
 * @param laenge        	Die Anzahl Komponenten des Arrays.
 *
 * @return	Gibt an ob alle Werte im Array ungerade sind (1) oder nicht (0).
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
/**Liefert die Haeufigkeitsverteilung der Werte eines char-Arrays.
 *
 * @param array   			\c Input:  \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wird.\n
 *                     	\c Output: \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wurde
 * @param laenge        Die Anzahl der Komponenten.
 * @param haeufigkeitsverteilung   	\c Input:  \n Die Adresse, an der die Haeufigkeitsverteilung gespeichert wird.\n
 *			                      			\c Output: \n Die Adresse, an der die Haeufigkeitsverteilung gespeichert wurde.
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
/**Liefert die Haeufigkeitsverteilung der Werte eines zweidimensionale char-Arrays.
 *
 ...
 * @param array   			\c Input:  \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wird.\n
 *                     	\c Output: \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wurde.
 * @param spalten       Die Anzahl der Komponenten.
 * @param haeufigkeitsverteilung   	\c Input:  \n Die Adresse, an der die Haeufigkeitsverteilung gespeichert wird.\n
 *			                      			\c Output: \n Die Adresse, an der die Haeufigkeitsverteilung gespeichert wurde.
 *
 * @author	Viktor Schmidt, s0529652
...
void haeufigkeitsverteilung_2dim_char_array(int zeilen, int spalten, char **array, int *haeufigkeitsverteilung)
{
	...
	{
		haeufigkeitsverteilung_char_array(array[i], spalten, haeufigkeitsverteilung);
	}
}

/**Liefert die Haeufigkeitsverteilung der Minima eines char-Arrays.
 *
 * @param array   			\c Input:  \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wird.\n
 *                     	\c Output: \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wurde
 * @param laenge        Die Anzahl der Komponenten.
 * @param minima		   	\c Input:  \n Die Adresse, an der die Haeufigkeitsverteilung der Minima gespeichert wird.\n
 *			            		\c Output: \n Die Adresse, an der die Haeufigkeitsverteilung der Minima gespeichert wurde.
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
void haeufigkeitsverteilung_minima_2dim_char_array(int zeilen, int spalten, char **array, int *minima)
{
	for (int i = 0; i < zeilen; i++)
	{
		haeufigkeitsverteilung_minima_char_array(array[i], spalten, minima);
	}
}

/**Liefert die Haeufigkeitsverteilung der Maxima eines char-Arrays.
 *
 * @param array   			\c Input:  \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wird.\n
 *                     	\c Output: \n Die Adresse auf ein Speicherbereich mit char-Werten das untersucht wurde
 * @param laenge        Die Anzahl der Komponenten.
 * @param maxima		   	\c Input:  \n Die Adresse, an der die Haeufigkeitsverteilung der Maxima gespeichert wird.\n
 *			            		\c Output: \n Die Adresse, an der die Haeufigkeitsverteilung der Maxima gespeichert wurde.
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
...
void haeufigkeitsverteilung_maxima_2dim_char_array(int zeilen, int spalten, char **array, int *maxima)
{
	for (int i = 0; i < zeilen; i++)
	{
		haeufigkeitsverteilung_maxima_char_array(array[i], spalten, maxima);
	}
}
