 ...
 * @return  Die erfasste Eingabe, z.B. true fuer "j" und false fuer "n",  wird zurueckgegeben.
 *
 * @author	Viktor Schmidt, s0529652
 * @version	1.0
 */
bool Eingaben::erfasse_antwort(const string ausgabetext, const string eingabeformat)
{
  ...
  try
  {
    while (!eingabeOK)
    {
      ...
      if (eingabe.at(0) == eingabeformat.at(0))
      {
        eingabeOK = true;
        antwort = true;
      }
      else if (eingabe.at(0) == eingabeformat.at(1))
      {
        eingabeOK = true;
        antwort = false;
      }
 ...
 *
 * @param ausgabetext     Text für die Frage/Beschreibung der Ausgabe.
 * @param eingabe         \c Input:   Das Array, in das die Zeichenkette geschrieben werden soll.\n
 *                        \c Output:  Dasselbe Array, in das die Zeichenkette geschrieben wurde.\n
 ...
 *
 * @param eingabe   \c Input:   Das Array, dessen Komponenten den Text beinhalten sollen.\n
 *                  \c Output:  Dasselbe Array, dessen Komponenten den Text beinhalten.\n
 * @param laenge    Die max. Laenge der Zeichenkette.
 */
