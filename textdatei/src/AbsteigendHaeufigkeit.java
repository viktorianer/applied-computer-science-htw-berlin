...
/**
 * Sortiert Woerter absteigend nach der Haeufigkeit.
 *
 * @author Viktor Schmidt, s0529652
 * @version 1.0
 */
class AbsteigendHaeufigkeit implements Comparator<Wort> {
    /**
     * Sortiert Woerter absteigend nach Haeufigkeit. Bei gleicheit werden diese zusaetzlich nach dem Wert,
     ...
     * @return Liefert beim Vergleich der Worte 1 wenn das erste großer, -1 wenn das zweite großer und 0
